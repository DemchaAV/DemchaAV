...
![Swagger](https://img.shields.io/badge/OpenAPI%2FSwagger-85EA2D?style=flat&logo=swagger&logoColor=black)
...
I actively use LLM APIs in my projects — not just as a buzzword:
- **CVRewriter**: multi-provider AI pipeline (Gemini, GPT, DeepSeek) with structured JSON output and `temperature: 0` for deterministic CV generation
- **GeminiAPI**: custom Java client with JSON Schema validation and assistant prefill
- Agent workflow tooling: skills-based prompt chaining, automated review/test/docs pipelines
